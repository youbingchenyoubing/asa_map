...
mdl1.write(file=modelname+restyp+chain+respos+'.tmp')
mdl1.read(file=modelname+restyp+chain+respos+'.tmp')
...
#give a proper name
mdl1.write(file=modelname+restyp+chain+respos+'.pdb')

#delete the temporary file
os.remove(modelname+restyp+chain+respos+'.tmp')
